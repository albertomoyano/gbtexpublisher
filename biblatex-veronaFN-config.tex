...
\usepackage[style=philosophy-verbose,% modelo para notas a pie
autocite=footnote,
citetracker=context,
ibidtracker=true,
pagetracker=true,
ibidpage=true,
indexing=true,
singletitle=false,% op. cit. para este modelo
sortcites=true,
backend=biber,
labeldateparts=true,
backref=true,
...
bibencoding=utf8,
latinemph=true,
commacit=true,% coma después del shorttitle
lowscauthors=true,
scauthorsbib=true,
annotation=true,
...
% agregamos vol y n.° en el modo footcite
...
\DefineBibliographyStrings{spanish}{%
	...
	seenote          = {véase nota},
	quotedin         = {citado en},
	opcit            = {\emph{op\adddotspace cit\adddot}},
	idem             = {ídem},
	idemsf           = {ídem},
	idemsm           = {ídem},
	idemsn           = {ídem},
