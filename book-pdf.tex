...
\def\@nombreautor#1{%
	\@nombreautor@split#1 \@nil%
}
\def\@nombreautor@split#1 y #2\@nil{%
	\ifx\relax#2\relax%
	\textsc{\MakeLowercase{#1}}% Solo un autor
	\else%
	\@nombreautor@multiple{#1}{#2}% Múltiples autores
	\fi%
}
\def\@nombreautor@multiple#1#2{%
	\textsc{\MakeLowercase{#1}} y \textsc{\MakeLowercase{#2}}%
}
\makeatother
