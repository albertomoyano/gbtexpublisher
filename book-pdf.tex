...
% Idiomas y babel
\usepackage[french,portuguese,italian,english,british,american,german,spanish,es-ucroman,es-noshorthands]{babel}
...
%% soporte matemático con Libertinus
\usepackage{unicode-math}
\setmathfont[Scale=1.18]{Libertinus Math}
...
\makeatletter
\g@addto@macro{\theindex}{\addcontentsline{toc}{chapter}{\hspace{2pc}Índice de autoras y autores del aparato bibliográfico}}
\makeatother
