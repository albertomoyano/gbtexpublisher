...
% control sobre parrafos de una linea
\usepackage{needspace}
\let\oldpar\par
\renewcommand{\par}{\Needspace{2\baselineskip}\oldpar}
...
%% rediseñamos la raya de las notas a pie
%% aumentamos la distancia de la raya
